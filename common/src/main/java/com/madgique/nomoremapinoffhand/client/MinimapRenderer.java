package com.madgique.nomoremapinoffhand.client;
...
public class MinimapRenderer {
    ...
    public static void renderMinimap(GuiGraphics guiGraphics, float partialTick) {
        ...
        // Get map from accessory slots using common interface
        ItemStack mapStack = MapUpdateManager.getMapForRendering(player);
        ...
        // Note: Map updates are handled by platform-specific tick handlers
